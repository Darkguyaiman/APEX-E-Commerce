  ...
  return (
    <div className="w-full max-w-sm space-y-8 mx-auto">
      ...
      <a
        ...
        className="w-full h-14 bg-primary text-background font-headline-md text-xl uppercase italic font-black flex items-center justify-center gap-3 hover:bg-primary-container hover:text-background transition-colors cursor-pointer"
      >
